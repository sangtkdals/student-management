...
const InfoCard = ({ icon, title, items, linkText }: { icon: React.ReactElement; title: string; items: string[]; linkText: string }) => (
        ...
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div>
            <button
              ...
              className="text-slate-600 hover:text-brand-blue font-semibold px-4 py-2 rounded-md transition-colors"
            >
              로그인
            </button>
          </div>
      ...
      <main>
        <section className="bg-brand-blue text-white">
          <div className="container mx-auto px-6 py-24 text-center">
            <h2 className="text-4xl font-extrabold sm:text-5xl">스마트한 대학 생활의 시작</h2>
            <p className="mt-4 max-w-2xl mx-auto text-lg text-blue-100">통합 학사 관리 시스템으로 학사 정보, 강의, 성적을 한 곳에서 관리하세요.</p>
