...
CREATE TABLE `tuition` (
    ...
    `tuition_amount` DECIMAL(10, 0) NULL DEFAULT NULL COMMENT '등록금 금액', 
    `scholarship_amount` DECIMAL(10, 0) NULL DEFAULT NULL COMMENT '장학금 금액',
    `paid_amount` DECIMAL(10, 0) NULL DEFAULT NULL COMMENT '납부 금액',
